...
// ── Hero Parallax (mobile/tablet only — avoids fixed-bg bleed) ─
// On <=1024px, mobile browsers ignore background-attachment: fixed.
// .hero-bg-fixed is position: absolute inside .hero, so it is clipped
// by .hero's overflow: hidden and cannot bleed past the section. We
// counteract page scroll with translateY so the image appears static
// while the hero is in view; once the hero scrolls away the effect
// stops naturally. Desktop (>1024px) uses CSS background-attachment.
(function () {
